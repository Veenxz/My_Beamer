...
%Add page numbers  4:3 55em  16:9 78em
...
%\setbeamertemplate{background}{\includegraphics[height=\paperheight]{logo.png}} 
...
\logo {\includegraphics [height = 0.21 \textheight] {logo.png}\vspace {0.77\textheight }}
...
\begin{CJK}{UTF8}{gbsn}   % 中间的UTF8编码参数是必须要写的 可选字体gbsn gkai
中文测试\\%
\end{CJK}
\end{frame}
