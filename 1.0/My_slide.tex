...
%添加页码
\addtobeamertemplate{navigation symbols}{}{\hspace{55 em}  \usebeamerfont{footlines}%
...
% -------------------
%Only Title
\titlegraphic{\includegraphics[height=0.1\textwidth]{logo_new.png}}

%All
%\logo{\includegraphics[width=1cm,height=1cm]{logo.png}}
